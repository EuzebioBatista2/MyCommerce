...
export default function Footer() {
    return (
        <div className={`flex w-full items-center h-14 bg-gray-800 dark:bg-gray-300 text-sm px-2 transition duration-500 ease-in-out`}>
            ...
            <p className={`flex items-center justify-end w-full mr-2 text-xs text-gray-200 dark:text-black`}>
