...
export default function Footer() {
    return (
        <div className={`flex w-full items-center h-14 bg-gray-800 dark:bg-gray-300 text-sm transition duration-500 ease-in-out`}>
            <div className="fold:hidden flex px-1 md:px-2">
            ...
            <p className={`flex items-center justify-end w-full text-xs md:text-sm mr-1 md:mr-2 text-center text-gray-200 dark:text-black`}>
